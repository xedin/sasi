...
public class Operation extends RangeIterator<Long, Token>
{
    ...
    private Operation(OperationType operation,
                      ...
                      ListMultimap<ByteBuffer, Expression> expressions,
    ...
    public static class Builder
    {
        ...
        public Operation complete()
        {
            ...
            {
                ListMultimap<ByteBuffer, Expression> analyzedExpressions = analyzeGroup(controller, comparator, op, expressions);
