...
import org.apache.cassandra.db.index.sasi.utils.CombinedTermIterator;
import org.apache.cassandra.db.index.sasi.utils.OnDiskIndexIterator;
...
public class OnDiskIndexTest
{
    ...
    public void testIntegerSAConstruction() throws Exception
    {
        ...
        OnDiskIndexBuilder iterTest = new OnDiskIndexBuilder(UTF8Type.instance, Int32Type.instance, OnDiskIndexBuilder.Mode.ORIGINAL);
    ...
    {
        OnDiskIndexBuilder builderA = new OnDiskIndexBuilder(UTF8Type.instance, LongType.instance, OnDiskIndexBuilder.Mode.ORIGINAL);
        OnDiskIndexBuilder builderB = new OnDiskIndexBuilder(UTF8Type.instance, LongType.instance, OnDiskIndexBuilder.Mode.ORIGINAL);
        ...
        OnDiskIndexBuilder combined = new OnDiskIndexBuilder(UTF8Type.instance, LongType.instance, OnDiskIndexBuilder.Mode.ORIGINAL);
    ...
    private static TokenTreeBuilder keyBuilder(Long... keys)
    {
        ...
        for (final Long key : keys)
        {
            ...
            builder.add((Long) dk.token.token, key);
        }
    ...
    private static Expression expressionForNot(Integer lower, Integer upper, Integer... terms)
    {
        return expressionForNot(Int32Type.instance,
                ...
                Iterables.transform(Arrays.asList(terms), new Function<Integer, ByteBuffer>()
                {
                    @Override
    ...
    private static Expression expressionForNot(String lower, String upper, String... terms)
    {
        return expressionForNot(UTF8Type.instance,
                ...
                Iterables.transform(Arrays.asList(terms), new Function<String, ByteBuffer>()
                {
                    @Override
